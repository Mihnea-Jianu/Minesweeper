...
# CMake will generate the necessarry Makefiles or project files with which to compile the program. 
...
# GLFW_BUILD_EXAMPLES, GLFW_BUILD_TESTS and GLFW_BUILD_DOCS, all set to OFF.

# This is because we are not interested in building the examples, tests or docs
# for GLFW, we are simply interested in compiling the library binary.
...
# CMake can handle the compilation for us, regardless of what method is used.
